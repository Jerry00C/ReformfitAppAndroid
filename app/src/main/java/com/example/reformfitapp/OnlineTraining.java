 ...
 * Use the {@link OnlineTraining#newInstance} factory method to
 * create an instance of this fragment.
 */
public class OnlineTraining extends Fragment {
    ...
    ArrayList<ArrayList<MindbodyClassModel>> modelsOnline;
    ...
    public OnlineTraining(ArrayList<ArrayList<MindbodyClassModel>> modelsOnlineFrom, boolean fragment) {
        // Required empty public constructor
     ...
     * @return A new instance of fragment OnlineTraining.
     */
    // TODO: Rename and change types and number of parameters
    public static OnlineTraining newInstance(String param1, String param2) {
        OnlineTraining fragment = new OnlineTraining();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("online_class", modelsOnline.get(0).get(0).toString());
        ...
        for(int index = 0; index < 14; index++){
            ...
            dates_for_request.add(curr_year + "-" + curr_month + "_" + curr_date);
        ...
        PagerAdapter adapter1 = new GroupClassViewpagerAdapter(getActivity(),  getChildFragmentManager(), dates, modelsOnline, fragment);
