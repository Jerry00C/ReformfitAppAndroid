...
public class TDEECalculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        info_thresh = findViewById(R.id.info);
        warning_thresh = findViewById(R.id.faq);
        ...
        initCalculate = findViewById(R.id.init_calculate);
        initCalculate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.sliding_up,R.anim.sliding_down).add(R.id.outer_container, tdee).commitNow();
    ...
    public void onBackPressed() {
        ...
        if(getSupportFragmentManager().getFragments().contains(tdee)){
            getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.sliding_down,R.anim.sliding_down).remove(tdee).commitNow();
