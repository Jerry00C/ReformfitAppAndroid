...
public class BMICalculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.sliding_up,R.anim.sliding_down).add(R.id.outer_container, bmi).commitNow();
    ...
    public void onBackPressed() {
        ...
        if(getSupportFragmentManager().getFragments().contains(bmi)){
            getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.sliding_down,R.anim.sliding_down).remove(bmi).commitNow();
