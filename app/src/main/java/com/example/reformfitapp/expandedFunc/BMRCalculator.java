...
public class BMRCalculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.sliding_up,R.anim.sliding_down).add(R.id.outer_container, bmr).commitNow();
    ...
    public void onBackPressed() {
        ...
        if(getSupportFragmentManager().getFragments().contains(bmr)){
            getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.sliding_down,R.anim.sliding_down).remove(bmr).commitNow();
